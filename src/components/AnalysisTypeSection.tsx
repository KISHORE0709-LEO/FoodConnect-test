      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="feature-card">
            ...
            <Link
              to="/generic"
              className="w-full flex items-center justify-center gap-2 py-3 rounded-lg gradient-button text-primary-foreground font-medium hover:opacity-90 transition-opacity"
            >
          ...
          <div className="feature-card">
            ...
            <Link
              to="/customized"
              className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-accent text-accent-foreground font-medium hover:opacity-90 transition-opacity"
            >
